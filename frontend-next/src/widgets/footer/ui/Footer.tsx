            ...
            <div className="mx-auto flex w-full max-w-[1200px] flex-wrap items-start justify-between gap-8 px-4 sm:px-6">
                ...
                <section className="min-w-[220px] flex-1 basis-[240px]">
                    ...
                    <div className="space-y-1.5">
                        {navLinks.map((item) => (
                            <Link key={item.href} href={item.href} className="block text-sm text-white hover:underline">
                                {item.label}
                            </Link>
                        ))}
                    </div>
                ...
                <section className="min-w-[220px] flex-1 basis-[240px]">
                    ...
                    <Link href="tel:+79120770429" className="mt-1 block text-sm text-white hover:underline">
